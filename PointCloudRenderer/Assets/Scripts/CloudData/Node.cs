    ...
    public class Node : IEnumerable<Node> {
        ...
        public void CreateGameObjects(MeshConfiguration configuration, Transform parent) {
            ...
            if (verticesToStore.Length <= max) {
                gameObjects.Add(configuration.CreateGameObject(metaData.cloudName + "/" + "r" + name + " (" + verticesToStore.Length + ")", verticesToStore, colorsToStore, boundingBox, parent, metaData.spacing / (float)(GetLevel() + 1)));
            } else {
                ...
                while (amount > 0) {
                    ...
                    gameObjects.Add(configuration.CreateGameObject(metaData.cloudName + "/" + "r" + name + "_" + index + " (" + vertices.Length + ")", vertices, colors, boundingBox, parent, metaData.spacing / (float)(GetLevel() + 1)));
