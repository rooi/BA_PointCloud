                    ...
                    if (types != null)
                    {
                        ...
                        for (ulong p = 0; p < view.Size; p++)
                        {
                            ...
                            for (uint i = 0; i < size; ++i)
                            {
                                ...
                                {
                                    value = BitConverter.ToDouble(point, positionInterp).ToString();
                                }
                                else if (interpretationName == "float")
                                {
                                    value = BitConverter.ToSingle(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("uint64"))
                                {
                                    value = BitConverter.ToUInt64(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("uint32"))
                                {
                                    value = BitConverter.ToUInt32(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("uint16"))
                                {
                                    value = BitConverter.ToUInt16(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("uint8"))
                                {
                                    value = point[positionInterp].ToString();
                                }
                                else if (interpretationName.StartsWith("int64"))
                                {
                                    value = BitConverter.ToInt64(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("int32"))
                                {
                                    value = BitConverter.ToInt32(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("int16"))
                                {
                                    value = BitConverter.ToInt16(point, positionInterp).ToString();
                                }
                                else if (interpretationName.StartsWith("int8"))
                                {
                                    value = ((sbyte)point[positionInterp]).ToString();
                                }
                                ...
                                //if (type.IdName == "Blue")  b = point[positionInterp + 1]; // optimize this
                            ...
                            colors[(int)(pointCounter)] = new Color32(r, g, b, 255);
